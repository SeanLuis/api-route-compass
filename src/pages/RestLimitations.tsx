  ...
  return (
    <PageLayout>
      <PageContent
        ...
        description="Restricciones y desafíos del modelo REST para APIs complejas."
        path={["API Avanzada", "Limitaciones REST"]}
      >
        <p>
        ...
        <h2>Fetching de datos ineficiente</h2>
        ...
        <h3>Soluciones parciales en REST</h3>
        ...
        <div className="mb-6">
          <h3 className="font-semibold mb-2">El problema de las modificaciones en masa</h3>
          <p>
                ...
                code={`POST /api/batch-operations
{
  "operations": [
    ...
    ...
        ...
        <h2>Operaciones que no se ajustan al paradigma CRUD</h2>
        ...
        <div className="space-y-4 mb-8">
          <div>
            <h4 className="font-semibold">Acciones y procesos</h4>
            <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div className="bg-slate-100 p-3 rounded-md">
                <h5 className="font-medium">Aproximación REST forzada</h5>
                <RouteExample
                  method="PUT"
                  path="/api/orders/123"
                  description="Actualizar orden completa para aprobarla"
                />
                <code className="block text-xs mt-2 bg-slate-200 p-2 rounded">
                  {`{ "status": "approved", ... otros campos obligatorios ... }`}
                </code>
              </div>

              <div className="bg-slate-100 p-3 rounded-md">
                <h5 className="font-medium">Interpretación pragmática</h5>
                <RouteExample
                  method="POST"
                  path="/api/orders/123/approve"
                  description="Acción específica (menos RESTful pero más clara)"
                />
                <code className="block text-xs mt-2 bg-slate-200 p-2 rounded">
          ...
          <div>
            <h4 className="font-semibold">Flujos de trabajo complejos</h4>
            <p>
        ...
        <h2>Documentación y contratos débiles</h2>
        ...
        <h2>Rendimiento y latencia de red</h2>
        ...
        <h2>¿Cuándo considerar alternativas a REST?</h2>
