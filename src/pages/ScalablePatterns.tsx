  ...
  return (
    <PageLayout>
      <PageContent
        ...
        description="Arquitecturas y patrones para APIs REST de gran escala."
        path={["API Avanzada", "Patrones Escalables"]}
      >
        <p>
        ...
        <h2>Arquitecturas API Gateway</h2>
        ...
        <div className="mb-8">
          ...
          <div className="border border-gray-200 rounded-md p-4 mb-4 bg-gray-50">
            <img 
              src="https://user-images.githubusercontent.com/4596845/69635107-47fa1f00-105d-11ea-99a7-6bc2230d1843.png"
              alt="Diagrama del patrón BFF (Backend for Frontend)"
        ...
        <h2>Arquitecturas basadas en eventos</h2>
...
// (enviar email, actualizar inventario, etc.)`}
        ...
        <div className="bg-emerald-50 border border-emerald-200 rounded-md p-4 mb-8">
