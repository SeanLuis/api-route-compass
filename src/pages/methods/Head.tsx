          ...
          <div className="space-y-6">
            <div className="border rounded-lg overflow-hidden shadow-sm">
              <div className="p-5 border-b bg-slate-50">
                ...
                <p className="text-sm text-slate-600">Comprueba si un recurso existe sin descargar su contenido</p>
              </div>
              <div className="p-5">
                <EndpointExample 
                  method="HEAD"
...
[No body returned]`}
            ...
            <div className="border rounded-lg overflow-hidden shadow-sm">
              <div className="p-5 border-b bg-slate-50">
                ...
                <p className="text-sm text-slate-600">Verifica si un recurso ha sido modificado utilizando cabeceras de caché</p>
              </div>
              <div className="p-5">
                <EndpointExample 
                  method="HEAD"
...
[No body returned]`}
            ...
            <div className="border rounded-lg overflow-hidden shadow-sm">
              <div className="p-5 border-b bg-slate-50">
                ...
                <p className="text-sm text-slate-600">Comprueba el tamaño de un archivo antes de descargarlo</p>
              </div>
              <div className="p-5">
                <EndpointExample 
                  method="HEAD"
...
[No body returned]`}
        ...
        <section className="space-y-6 pt-6">
          ...
          <Alert variant="default" className="bg-blue-50 border-blue-100">
            ...
            <AlertTitle className="text-blue-800 text-base">Coherencia con GET</AlertTitle>
          ...
          <div className="border rounded-lg overflow-hidden shadow-sm">
            <table className="w-full border-collapse">
              <tbody>
                ...
                <tr>
                  <td className="p-4 bg-slate-50 font-medium">500 Internal Server Error</td>
            ...
            <table className="w-full border-collapse bg-white shadow-sm rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-slate-100">
                  <th className="p-4 text-left font-medium text-slate-600">Característica</th>
                  <th className="p-4 text-left font-medium text-slate-600">HEAD</th>
                  <th className="p-4 text-left font-medium text-slate-600">GET</th>
                </tr>
              </thead>
              <tbody>
...
module.exports = router;`}
          ...
          <Alert className="bg-slate-50 border-slate-100">
            ...
            <AlertTitle className="text-slate-800 text-base">Nota sobre Express</AlertTitle>
