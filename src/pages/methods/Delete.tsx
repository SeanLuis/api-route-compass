          ...
          <div className="space-y-6">
            <div className="border rounded-lg overflow-hidden shadow-sm">
              <div className="p-5 border-b bg-slate-50">
                ...
                <p className="text-sm text-slate-600">Elimina un producto específico</p>
              </div>
              <div className="p-5">
                <EndpointExample
                  method="DELETE"
  ...
  "message": "El producto ha sido eliminado correctamente"
            ...
            <div className="border rounded-lg overflow-hidden shadow-sm">
              <div className="p-5 border-b bg-slate-50">
                ...
                <p className="text-sm text-slate-600">Cierra una sesión del usuario (logout)</p>
              </div>
              <div className="p-5">
                <EndpointExample
                  method="DELETE"
            ...
            <div className="border rounded-lg overflow-hidden shadow-sm">
              <div className="p-5 border-b bg-slate-50">
                ...
                <p className="text-sm text-slate-600">Elimina un dispositivo y envía notificación</p>
              </div>
              <div className="p-5">
                <EndpointExample
                  method="DELETE"
  ...
  "user_id": "user_456"
          ...
          <div className="border rounded-lg overflow-hidden shadow-sm">
            <table className="w-full border-collapse">
              <tbody>
                ...
                <tr>
                  <td className="p-4 bg-slate-50 font-medium">423 Locked</td>
        ...
        <section className="space-y-6 pt-6">
          ...
          <Alert variant="default" className="bg-blue-50 border-blue-100">
            ...
            <AlertTitle className="text-blue-800 text-base">Eliminación condicional</AlertTitle>
...
If-Match: "33a64df551425fcc55e4d42a148795d9f25f89d4"`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="border rounded-lg overflow-hidden shadow-sm">
                ...
                <div className="p-5">
                  <p className="text-sm text-slate-700 mb-4">Elimina completamente el recurso del sistema.</p>
                  <CodeBlock
...
HTTP/1.1 204 No Content`}
              ...
              <div className="border rounded-lg overflow-hidden shadow-sm">
                ...
                <div className="p-5">
                  <p className="text-sm text-slate-700 mb-4">Marca el recurso como eliminado, pero lo mantiene en el sistema.</p>
                  <CodeBlock
...
HTTP/1.1 200 OK
{
  ...
  "deleted_at": "2023-06-11T10:45:00Z"
            ...
            <Alert variant="default" className="bg-amber-50 border-amber-100">
              ...
              <AlertTitle className="text-amber-800 text-base">Manejo de recursos con dependencias</AlertTitle>
