    ...
    <PageLayout>
      <div className="space-y-10">
        ...
        <div className="border-b pb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight mt-3 mb-4">Autenticación en APIs REST</h1>
...
// Respuesta
{
  ...
  "expires_in": 3600
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-blue-50 p-6 rounded-lg border border-indigo-100 mb-8">
            <h4 className="text-indigo-900 font-medium mb-3">Almacenamiento de contraseñas</h4>
