  ...
  return (
    <PageLayout>
      <PageContent
        ...
        path={["Inicio", "Relaciones", "Expansión de Campos"]}
      >
          ...
          <CardContent className="p-0">
            <div className="border-b border-slate-200 dark:border-slate-700 p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-semibold dark:text-white">1. Expansión mediante Parámetro "expand" o "include"</h3>
              </div>
  ...
  "reviews": [
    ...
    },
    {
      ...
      "author": "Ana L."
              ...
              <p className="dark:text-slate-300">Diferentes variantes de sintaxis para este enfoque:</p>
          ...
          <CardContent className="p-0">
            <div className="border-b border-slate-200 dark:border-slate-700 p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-semibold dark:text-white">2. Expansión Selectiva de Campos</h3>
              </div>
              <p className="text-slate-700 dark:text-slate-300">
          ...
          <CardContent className="p-0">
            <div className="border-b border-slate-200 dark:border-slate-700 p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-semibold dark:text-white">3. Expansión con Niveles de Profundidad</h3>
              </div>
              <p className="text-slate-700 dark:text-slate-300">
        ...
        <div className="space-y-6 mt-4">
          <Card className="dark:border-slate-700">
            <CardContent className="pt-6">
              <h3 className="font-semibold mb-2 dark:text-white">Control de Rendimiento</h3>
          ...
          <Card className="dark:border-slate-700">
            <CardContent className="pt-6">
              <h3 className="font-semibold mb-2 dark:text-white">Consistencia en las Respuestas</h3>
              <p className="mb-3 text-sm text-slate-600 dark:text-slate-400">
...
// Con expansión (mantiene los IDs originales)
{
  ...
  "brand": {
    ...
    "name": "TechCorp"
        ...
        <div className="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-950/50 dark:to-blue-950/50 p-6 rounded-lg border border-indigo-100 dark:border-indigo-800 mt-6">
          <h3 className="font-semibold mb-2 text-indigo-900 dark:text-indigo-300">Implementación con Control de Rendimiento</h3>
  ...
  Product.findByPk(id, { include })
    ...
    .catch(err => res.status(500).json({ error: err.message }));
        ...
        <Card className="mt-6 dark:border-slate-700">
          <CardContent className="pt-6">
            <h3 className="font-semibold mb-2 dark:text-white">Documentación Clara</h3>
            <p className="mb-3 text-sm text-slate-600 dark:text-slate-400">
        ...
        <div className="space-y-6 mt-4">
          <Card className="dark:border-slate-700">
            <CardContent className="pt-6">
              <h3 className="font-semibold mb-2 dark:text-white">Expansión Condicional</h3>
              <p className="mb-3 text-sm text-slate-600 dark:text-slate-400">
...
GET /api/v1/users/123?expand=orders(status=delivered&created_after=2023-01-01)`}
          ...
          <Card className="dark:border-slate-700">
            <CardContent className="pt-6">
              <h3 className="font-semibold mb-2 dark:text-white">Expansión con Paginación Interna</h3>
              <p className="mb-3 text-sm text-slate-600 dark:text-slate-400">
  ...
  "reviews": {
    ...
    "pagination": {
      ...
      "pages": 5
        ...
        <Card className="mt-6 dark:border-slate-700">
          <CardContent className="pt-6">
            <h3 className="font-semibold mb-2 dark:text-white">Expansión con Metadatos</h3>
            <p className="mb-3 text-sm text-slate-600 dark:text-slate-400">
          ...
          <CardContent className="p-0">
            <div className="border-b border-slate-200 dark:border-slate-700 p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-semibold dark:text-white">Expansión en APIs de E-commerce</h3>
              </div>
              <p className="text-slate-700 dark:text-slate-300">
    ...
    },
    {
      ...
      "thumbnail": "https://example.com/thumbnails/cargador.jpg"
        ...
        <div className="space-y-6 mt-4">
          <Card className="dark:border-slate-700">
            <CardContent className="pt-6">
              <h3 className="font-semibold mb-2 dark:text-white">Expansión en APIs de Redes Sociales</h3>
              <p className="mb-3 text-sm text-slate-600 dark:text-slate-400">
...
GET /api/v1/users/123?expand=followers.profile`}
          ...
          <Card className="dark:border-slate-700">
            <CardContent className="pt-6">
              <h3 className="font-semibold mb-2 dark:text-white">Expansión en APIs de SaaS B2B</h3>
              <p className="mb-3 text-sm text-slate-600 dark:text-slate-400">
